...
function error-message {
   echo "Errors are sent to stderr" >&2
}
...
function cleanup {
  rm /tmp/*.$$
  echo "Temporary files created by script are removed"
  exit
}
